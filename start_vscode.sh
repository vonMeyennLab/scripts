...
code-server --auth none --extensions-dir=/cluster/work/nme/software/libraries/code-server/3.12.0 --verbose --proxy-domain=http://proxy.ethz.ch:3128 --bind-addr="\${VSC_IP_REMOTE}:8899"
ENDBSUB
